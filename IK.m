...
function [l n R s] = IK(pose, s, u)

% givens
%pose = [0 0 800 0 0 0]';  % desired pose [x,y,z,a,b,c]T in mm and degrees
...
if nargin < 2 % if the s and u matriced were not provided, calculate
